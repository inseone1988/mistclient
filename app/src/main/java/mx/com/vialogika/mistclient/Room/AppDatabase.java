...
@Database(entities = {Reporte.class,Comment.class,Site.class,Guard.class,Apostamiento.class,Client.class,Provider.class,EdoReport.class,GuardForceState.class},version = 2,exportSchema = false)
