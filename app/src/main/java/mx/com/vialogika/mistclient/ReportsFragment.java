...
public class ReportsFragment extends Fragment {
    ...
    private void fetchIncidents(int from){
        new loadIncidents().execute(this.getContext());
    }

    private class loadIncidents extends AsyncTask<Context,Void,Void>{
        @Override
        ...
        protected Void doInBackground(Context... context) {
            NetworkRequest.fetchIncidents(context[0], 1, 1, new NetworkRequestCallbacks() {
                @Override
